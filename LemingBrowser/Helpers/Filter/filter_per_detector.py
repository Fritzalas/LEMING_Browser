...
def detector_filter_cut_rdataframe(
    ...
    """
    ****** Deprecated with the new loaf format. If you want only MuonEntranceEnergy > 200 and keep other columns***********
    ****** untouched then use the column filter function at the tram files. ***********************************************
