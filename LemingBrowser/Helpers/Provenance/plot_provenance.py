...
def _operation_key(
    ...
    if (
        "define columns" in operation
        or "defined columns" in operation
    ):
...
def _format_definition_lines(
    definitions: Any,
) -> list[str]:
    """
    Format user-defined dataframe columns for the compact
    provenance graph.
    """
