...
from Canvas.tramcanvashelper import (
    create_1D_tram_canvas,
    create_tram_2d_canvases,
)
from Classes.TramQuantitySpec import TramQuantitySpec
from Exceptions.PlotCreationError import PlotCreationError
from SaveFiles.savecanvas import save_canvas
...
def plot_tram_histo(
    ...
    """
    Plot already-created tram ROOT histograms.
    """
    ...
    if histogram_data_1d:
        ...
        canvas_result_1d = create_1D_tram_canvas(
    ...
    if histogram_data_2d:
        ...
        canvas_data_2d = create_tram_2d_canvases(
...
def _validate_and_normalize_histograms(
    ...
    if _is_root_histogram(histograms):
        ...
        spec = _get_tram_quantities(expression)[0]
    ...
    if _is_root_histogram(first_value):
        ...
        items: list[
            tuple[TramQuantitySpec, str, Any]
        ] = []
...
def _build_histogram_metadata(
    ...
    """Build metadata required by the tram canvas helpers."""
