"""
160 standalone black-box tests for detector_filter_cut_rdataframe.
...
# ===========================================================================
#
# These specifically exercise detector_filter_cut_rdataframe through the
# global vector-mask path after ApplyMask was changed so that:
#
#     values == []  -> keep []
#
# while aligned non-empty vectors are still filtered normally.
# ===========================================================================


EMPTY_VECTOR_CASES = [
    (
        "target_numeric_cut_keeps_empty_unrelated_vector",
        [
            {
                "Idetname": "A",
                "Energy": [1, 2, 3],
    ...
    (
        "target_abs_difference_keeps_empty_right_side",
        [
            {
                "Idetname": "A",
    ...
    (
        "target_compound_bool_numeric_keeps_empty_vector",
        [
            {
                "Idetname": "A",
    ...
    (
        "target_string_vector_cut_keeps_empty_numeric_side",
        [
            {
                "Idetname": "A",
                "Particle": ["muon", "electron", "proton", "muon"],
                "Energy": [60, 500, 300, 120],
        ...
        "A",
        'RunType == "Physics" && Particle != "electron" && Good && Energy >= 50',
        [
            {
                "Idetname": "A",
                "Particle": ["muon", "proton"],
    ...
    (
        "target_force_or_vector_keeps_empty_collection",
        [
            {
                "Idetname": "A",
                "Force": False,
    ...
    (
        "two_target_rows_empty_opposite_side_different_masks",
        [
            {
                "Idetname": "A",
                "Z1L": [10.0, 20.0, 30.0],
    ...
    (
        "two_detectors_same_vector_rule_empty_unrelated",
        [
            {
                "Idetname": "A",
                "Energy": [10, 60, 100],
    ...
    (
        "deep_nested_target_cut_multiple_empty_types",
        [
            {
                "Idetname": "A",
                "Name": ["muon", "electron", "proton", "muon", "gamma"],
                "Good": [True, False, True, True, True],
                "Energy": [70, 500, 300, 150, 1000],
                "Time": [1, 2, 3, 4, 5],
                "EmptyInt": [],
                "EmptyBool": [],
                "EmptyString": [],
        ...
        (
            "Enabled && ("
            '(Name == "muon" && Good && Energy >= 50 && Time <= 4) || '
            '(Name == "proton" && Good && Energy >= 250) || '
            '(Name != "gamma" && !Good && Energy > 900)'
            ")"
        ),
        [
            {
    ...
    (
        "custom_detector_column_with_empty_opposite_vectors",
        [
            {
                "Idetname": "Left",
                "Z1": [1.0, 2.0, 3.0],
    ...
    (
        "target_row_rejected_even_with_empty_unrelated_vectors",
        [
            {
                "Idetname": "A",
                "Energy": [1, 2, 3],
