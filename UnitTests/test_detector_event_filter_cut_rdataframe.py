...
Exactly 150 standalone stress tests for detector_event_filter_cut_rdataframe.
...
def test_empty_vector_all_is_true():
    ...
    check(rows, ["A", "B"], ["EnergyVec > 10", "EnergyVec < 10"], rows, seed=92028)
